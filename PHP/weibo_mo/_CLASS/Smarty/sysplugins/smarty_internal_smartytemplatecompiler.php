    ...
    protected function doCompile($_content)
    {
       ...
       then written to compiled files. */ 
        ...
        while ($this->lex->yylex() && !$this->abort_and_recompile) {
            if (isset($this->smarty->_parserdebug)) echo "<pre>Line {$this->lex->line} Parsing  {$this->parser->yyTokenName[$this->lex->token]} Token " . htmlspecialchars($this->lex->value) . "</pre>";
