...
console.log(Date.now() - window.st);

clearTimeout(window.loadDefault);
...
<li class="tile ${drag} empty-tile">\
  <a class="link" url="">\
	...
	var css_prefix = newver_path + 'css/';
	var js_prefix = newver_path + 'js/';
	loadjscssfile(css_prefix + "styl.css", "css");
	loadjscssfile(js_prefix + "config.js", "js");
	loadjscssfile(js_prefix + "jquery-ui-1.9.1.custom.min.js", "js");
	loadjscssfile(js_prefix + "jquery.autocomplete.js", "js");
	loadjscssfile(js_prefix + "jquery.validate.min.js", "js");
	loadjscssfile(js_prefix + "storage_util.js", "js");
	loadjscssfile(js_prefix + "new_page.js", "js");
	loadjscssfile(js_prefix + "stat.js", "js");
});
